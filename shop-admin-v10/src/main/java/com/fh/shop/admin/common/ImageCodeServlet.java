...
import com.fh.shop.admin.utils.CookieUtil;
...
public class ImageCodeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String sessionId = DistributedSession.getSession(req, resp);
         //set值                                               //过期时间
        RedisUtil.setEx(KeyUtil.buildCodeKey(sessionId),SystemConstant.CODE_EXPIRE,randomString);
